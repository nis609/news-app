...
class NewsDetailsState extends State<NewsDetails> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(NewsDetails oldWidget) {
...
final String? url;
final String? title;
  const NewsDetails({Key? key, this.url, this.title}) : super(key: key);
  @override
  createState() => NewsDetailsState();
}