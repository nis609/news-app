...
import 'module/home_screen/view/news_screen.dart';
...
class MyHomePage extends StatefulWidget {
  ...
  const MyHomePage({Key? key, this.id,required this.video}) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    return YoutubePlayerBuilder(
      ...
      player: YoutubePlayer(
        ...
        onEnded: (data) {
          _controller
              .load(widget.video[(widget.video.indexOf('${data.videoId}') + 1) % widget.video.length]);
